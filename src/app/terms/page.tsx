  ...
  return (
    <LegalLayout title="Terms of Service" lastUpdated="March 18, 2026">
      <section className="space-y-6">
        ...
        <p>By accessing DostAI via Telegram or our Website, you agree to be bound by these terms. This service is provided "as is" for entertainment purposes.</p>
        ...
        <p>The AI models and character definitions (Manifestos) are the property of DostAI. User-generated chat history is and remains the property of the user, processed under license to provide the service.</p>

        <h2 className="text-2xl font-medium text-[#FFB300]">5. Limitation of Liability</h2>
        <p>DostAI is not liable for any emotional distress, misinformation, or perceived loss resulting from interaction with our fictional AI characters.</p>
      </section>
    </LegalLayout>
  );
}
